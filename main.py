...
# Extrai as tabelas do PDF e salva em csv com as colunas estruturadas
# O parâmetro guess=False é para forçar o tabula a pegar todas as tabelas do documento
tabula.convert_into("./data/extrato.pdf", "./data/extrato.csv", output_format="csv", pages='all', guess=False)
